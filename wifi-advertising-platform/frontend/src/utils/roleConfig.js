...
export const navigationItems = {
  admin: [
    ...
    { id: 'users', icon: <Users size={20} />, label: 'Users', route:"/admin/users"},
    { id: 'transactions', icon: <CreditCard size={20} />, label: 'Transactions', route:"/admin/transactions"},
    { id: 'settings', icon: <Settings size={20} />, label: 'Settings', route:"/admin/settings"},
    { id: 'profile', icon: <User size={20} />, label: 'Profile', route:"/admin/profile"},
  ],
  merchant: [
    { id: 'dashboard', icon: <Home size={20} />, label: 'Dashboard' , route:"/merchant"},
    { id: 'wifi', icon: <Wifi size={20} />, label: 'WiFi', route:"/merchant/WiFi"},
    { id: 'ads', icon: <PieChart size={20} />, label: 'Ads', route:"/merchant/ads"},
    { id: 'revenue', icon: <CreditCard size={20} />, label: 'Revenue', route:"/merchant/revenue"},
  ...
  advertiser: [
    ...
    { id: 'campaigns', icon: <Award size={20} />, label: 'Campaigns'  , route:"/advertiser/campaigns"},
    { id: 'analytics', icon: <BarChart size={20} />, label: 'Analytics' , route:"/advertiser/analytics"},
    { id: 'payments', icon: <CreditCard size={20} />, label: 'Payments' , route:"/advertiser/payments"},
    { id: 'profile', icon: <User size={20} />, label: 'Profile' , route:"/advertiser/profile"},
  ],
  user: [
