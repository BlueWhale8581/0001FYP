...
const ProfilePage = () => {
  ...
  const { profile, loading: profileLoading, error } = useProfile("agent");

  if (authLoading) {
    return <DashboardTemplate role="agent" pageTitle="Loading..." />;
  }
  ...
  return (
    <DashboardTemplate role="agent" pageTitle="Agent Profile">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div>
                      ...
                      <div className="text-black">{profile.commission_rate|| 'N/A'}</div>
                    </div>
                    <div>
                      <label className="text-sm text-gray-500">Territory</label>
                      <div className="text-black">{profile.territory || 'N/A'}</div>
                    </div>
                  </div>
                </div>
              </Card>
