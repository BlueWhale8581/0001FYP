...
const ProfilePage = () => {
  ...
  const { profile, loading: profileLoading, error } = useProfile("admin");

  if (authLoading) {
    return <DashboardTemplate role="admin" pageTitle="Loading..." />;
  }
  ...
  return (
    <DashboardTemplate role="admin" pageTitle="Admin Profile">
